...
#if (MIPI_MBPS==500)
	pinfo.lcdc.h_back_porch = 170; // 120727_VFP changed 175;
	pinfo.lcdc.h_front_porch = 170; // 120727_VFP changed 175;   // HFP : ~1.03us
...
#error unknown MIPI_MBPS
	...
	pinfo.lcdc.v_front_porch = 25; // 120727_VFP changed 13;
